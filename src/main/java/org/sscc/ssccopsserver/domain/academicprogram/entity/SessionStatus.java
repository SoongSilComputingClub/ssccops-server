...
/*
 * sesn_stts_cd — 회차 실적 상태 (학술관리_데이터모델.md §3). sesn 행에 문자열로 저장될
 ...
 *
 * NOT_SUBMITTED는 sesn 행이 아예 없는 상태를 가리키는 파생 값이다 — 빈 행을 미리 만들어
...
public enum SessionStatus {
     ...
     * 달라지면 안 된다.
     *
     * NOT_SUBMITTED가 통과 값으로 보이지만 실제로는 닿지 않는다 — 그 값은 sesn 행이 없다는
