 ...
 *
 * 필드 이름을 컬럼(seqno · ttl · plan_dt)과 같게 두는 것은 이 값이 그 컬럼으로 그대로 들어가기
 ...
 * (ProposalFormSeed.CURRICULUM_LINE_FORMAT) — curriculum_item.plan_dt도 NULL 허용이다.
 */
public record CurriculumItemDraft(int seqno, String ttl, LocalDate planDt) {}
