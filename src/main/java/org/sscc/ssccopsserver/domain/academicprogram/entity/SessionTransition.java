...
/*
 * session_stts_cd 전이 액션 (#136 · POST .../sessions/{sessionId}/transitions).
 *
 ...
 *
 * 남길 승인 이력의 상태(academic_program_aprv.aprv_stts_cd)를 액션이 함께 들고 있는 것은,
...
public enum SessionTransition {
    ...
    /** 이 전이가 academic_program_aprv에 남길 처리 상태 */
