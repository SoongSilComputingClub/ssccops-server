...
/*
 * crclm_artcl(회차별 계획) — 기획안 제출과 원자적으로 등록되고 이후 불변인 계획
 * (#131, 학술관리_데이터모델.md §1·§4). 실제 진행 여부·내용(sesn, 실적)은 별도 테이블이며
...
public class CurriculumItemEntity {
    ...
    @Column(name = "ttl", nullable = false, length = 256)
    private String title;

    @Column(name = "plan_ymd")
