 ...
 *
 * **계획일(crclm_artcl.plan_ymd)은 정렬 키에 없다.** 승인 대기 목록(#136)의 "오래 기다린
 ...
 *
 * 두 정렬 키 모두 NULL일 수 없다. seqno는 crclm_artcl의 NOT NULL이고 actlYmd는
...
public enum SessionSortOrder {
    ...
    REAL_DT_ASC("actlYmd", SortKey.REAL_DT, false),
    REAL_DT_DESC("-actlYmd", SortKey.REAL_DT, true);
